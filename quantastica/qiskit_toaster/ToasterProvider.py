...
from .ToasterAsmSimulator import ToasterAsmSimulator
from .ToasterStatevectorSimulator import ToasterStatevectorSimulator
...
SIMULATORS = [
    ToasterStatevectorSimulator,
    ToasterAsmSimulator
]


class ToasterProvider(BasicAerProvider):
